...
from .views import all_users, change_user_data_by_admin, add_banners, all_movies, movie_detail, new_cinema, all_cinemas, cinema_detail, del_cinema, cinema_hall_detail, del_cinema_hall, new_cinema_hall
...
urlpatterns = [
    ...
    path('movie_detail/new_cinema/', new_cinema, name='new_cinema'),
